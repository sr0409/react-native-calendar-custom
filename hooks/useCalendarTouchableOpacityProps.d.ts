...
export declare function useCalendarTouchableOpacityProps<T>({ event, eventCellStyle, injectedStyles, onPressEvent, }: UseCalendarTouchableOpacityPropsProps<T>): CalendarTouchableOpacityProps;
export {};
