...
function _Calendar(_a) {
    ...
    var onSwipeHorizontal = React__default['default'].useCallback(function (direction) {
        ...
        if ((direction === 'LEFT' && !isRTL) || (direction === 'RIGHT' && isRTL)) {
            //testme(targetDate.add(modeToNum(mode, targetDate), 'day'))
